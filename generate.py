...
def Create_Robot():
    ...
    pyrosim.Send_Cube(name="Link0", pos=[0,1,1.5] , size=[length, width, height])
    ...
    pyrosim.Send_Joint(name = "Link0_Link2" , parent= "Link0" , child = "Link2" , type = "revolute", position = [0,1.5,1])
